...
/**
 * Servlet implementation class Retweet1
 */
@WebServlet("/Retweet1")
public class Retweet1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String id1 = request.getParameter("id1");		// imp 
		...
		if(id==null || tid_s == null){
			...
			boolean isr = Functions.isretweeted(tid, id);
			if(isr == false){
